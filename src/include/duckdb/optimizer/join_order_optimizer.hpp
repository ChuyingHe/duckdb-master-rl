...
public:
	explicit JoinOrderOptimizer(ClientContext &context) : context(context) { /*constructor, explicit prevent other type of parameter*/
	}

	//! Perform join reordering inside a plan
	unique_ptr<LogicalOperator> Optimize(unique_ptr<LogicalOperator> plan); /*this is the ONLY public function under the class, optimizer is called here!*/
